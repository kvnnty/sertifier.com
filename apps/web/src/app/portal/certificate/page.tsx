  ...
  return (
    <div className="max-w-5xl mx-auto my-8 space-y-12">
      ...
      <Textarea
        ...
        className="w-full text-lg p-4 border border-gray-200 bg-gray-50 rounded-lg focus:outline-none focus:ring-0 focus:ring-white min-h-[150px] text-gray-700 placeholder:text-gray-400 focus:shadow-none"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {suggestions.map((suggestion, i) => (
          <div
            key={i}
            className="bg-white rounded-lg border border-gray-200  p-6 flex flex-col justify-between min-h-[180px]"
          >
            <div
              ref={(el) => {
